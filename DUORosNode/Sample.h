...
namespace cl {
	...
	private:
		void init()
		{
			...
			_wndId = glutCreateWindow(_title);
		...
		{
			double z = 0.1;
			double x = tan(_fovX / 360.0 * 3.14159265358979323846) * z;
			double y = tan(_fovY / 360.0 * 3.14159265358979323846) * z;
			glBegin(GL_LINES);
